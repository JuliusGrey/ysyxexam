...
//  val	LD	 =	BitPat("b???????_?????_?????_011_?????_00000_11")
  ...
  val	MRET	 =	BitPat("b0011000_00010_00000_000_00000_11100 11")
  ...
  val	DMAEN	 =	BitPat("b0000110_?????_?????_110_?????_11110_11")



//  val	LUI	 =	BitPat("b???????_?????_?????_???_?????_01101_11")

val csrList = List(CSRRW,CSRRS,ECALL,MRET,CSRRSI,CSRRCI,CSRRC,CSRRWI)
...
//  CSRRW-> "CSRI",//特权立即数指令
  ...
  //  val typeMap :Map[String,Tuple2[UInt,UInt]] = Map(
//    "addi"->("b0010011".U(7.W),"b000".U(3.W))
//  )
